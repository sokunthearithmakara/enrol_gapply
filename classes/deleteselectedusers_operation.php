...
/**
 * A bulk operation for the gapply enrolment plugin to delete selected users enrolments.
 *
...
class enrol_gapply_deleteselectedusers_operation extends enrol_bulk_enrolment_operation {
     ...
     * @return enrol_gapply_deleteselectedusers_form
     */
    public function get_form($defaultaction = null, $defaultcustomdata = null) {
        ...
        return new enrol_gapply_deleteselectedusers_form($defaultaction, $defaultcustomdata);
    }
    ...
    public function process(course_enrolment_manager $manager, array $users, stdClass $properties) {
        global $DB;
        if (!has_capability("enrol/gapply:unenrol", $manager->get_context())) {
            return false;
        }
