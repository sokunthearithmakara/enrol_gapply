...
$string['alreadyapplied'] = '<b>Enrolment application was successfully sent on {$a}.</b><br/>You will be notified when your enrolment has been confirmed.';
$string['apply'] = 'Apply';
$string['applications'] = 'Applications';
$string['manage'] = 'Manage';
$string['participants'] = 'Participants';
$string['application'] = 'Application';
$string['userdetails'] = 'Applicant details';
...
$string['verified'] = 'Verified with HRCPD';
...
$string['notverified'] = 'Not verified with HRCPD';
$string['close'] = 'Close';
...
$string['connecthrmis'] = 'Connect to HRCPD';
